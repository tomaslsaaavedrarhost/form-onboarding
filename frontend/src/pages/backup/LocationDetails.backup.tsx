              ...
              <div key={String(index + 1)} className="bg-white shadow rounded-lg overflow-hidden">
                ...
                <div className={`transition-all duration-200 ease-in-out ${
                  ...
                  <div className="p-4 space-y-6">
                    ...
                    <SectionTitle>Eventos en Vivo</SectionTitle>
                    <div className="space-y-4">
                      <p className="mt-1 mb-4 text-sm text-gray-500">
                        Indique si su establecimiento cuenta con eventos diarios, semanales o artistas en vivo.
                      </p>
                      <div className="flex items-center space-x-4">
                        <label className="inline-flex items-center">
                          <Field
                            type="radio"
                            name={`locationDetails.${index}.liveEvents.hasLiveEvents`}
                            value={true}
                            checked={values.locationDetails[index].liveEvents.hasLiveEvents === true}
                            onChange={() => handleFieldChange(setFieldValue, `locationDetails.${index}.liveEvents.hasLiveEvents`, true)}
                            className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300"
                          />
                          <span className="ml-2 text-sm text-gray-700">Sí, tenemos eventos o artistas en vivo</span>
                        </label>
                        <label className="inline-flex items-center">
                          <Field
                            type="radio"
                            name={`locationDetails.${index}.liveEvents.hasLiveEvents`}
                            value={false}
                            checked={values.locationDetails[index].liveEvents.hasLiveEvents === false}
                            onChange={() => handleFieldChange(setFieldValue, `locationDetails.${index}.liveEvents.hasLiveEvents`, false)}
                            className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300"
                          />
                          <span className="ml-2 text-sm text-gray-700">No tenemos eventos o artistas en vivo</span>
                        </label>
                      </div>

                      {values.locationDetails[index].liveEvents.hasLiveEvents && (
                        <div className="space-y-4">
                          <div>
                            <label className="block text-sm font-medium text-gray-700">
                            ...
                            <Field
                              as="select"
                              name={`locationDetails.${index}.liveEvents.eventFrequency`}
                              className="mt-2 block w-full rounded-md border-gray-300 py-3 px-4 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                              onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleFieldChange(setFieldValue, `locationDetails.${index}.liveEvents.eventFrequency`, e.target.value)}
                            >
                          ...
                          <div>
                            ...
                            <Field
                              as="textarea"
                              name={`locationDetails.${index}.liveEvents.eventDescription`}
                              placeholder="Describa los tipos de eventos o artistas en vivo que presentan (música, comedia, etc.)"
                              rows={3}
                              className="mt-2 block w-full rounded-md border-gray-300 py-3 px-4 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                              onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => handleFieldChange(setFieldValue, `locationDetails.${index}.liveEvents.eventDescription`, e.target.value)}
                            />
                          </div>
                          ...
                          <div className="mt-4">
                            <div className="flex items-center space-x-4">
                              <label className="inline-flex items-center">
                                <Field
                                  type="checkbox"
                                  name={`locationDetails.${index}.liveEvents.promotedOnSocialMedia`}
                                  checked={values.locationDetails[index].liveEvents.promotedOnSocialMedia === true}
                                  onChange={() => handleFieldChange(setFieldValue, `locationDetails.${index}.liveEvents.promotedOnSocialMedia`, !values.locationDetails[index].liveEvents.promotedOnSocialMedia)}
                                  className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded"
                                />
                                <span className="ml-2 text-sm text-gray-700">
                                  Promovemos nuestros eventos en redes sociales
                                </span>
                              </label>
                            </div>
                          </div>

                          {values.locationDetails[index].liveEvents.promotedOnSocialMedia && (
                            <div className="space-y-4 pl-6 mt-2">
                              <p className="text-sm text-gray-500">
                                Proporcione enlaces a sus perfiles de redes sociales donde promociona los eventos
                              </p>
                              ...
                              <div>
                                ...
                                <Field
                                  type="text"
                                  name={`locationDetails.${index}.liveEvents.socialMediaLinks.instagram`}
                                  placeholder="https://instagram.com/su_perfil"
                                  className="mt-2 block w-full rounded-md border-gray-300 py-3 px-4 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleFieldChange(setFieldValue, `locationDetails.${index}.liveEvents.socialMediaLinks.instagram`, e.target.value)}
                                />
                              </div>
                              ...
                              <div>
                                ...
                                <Field
                                  type="text"
                                  name={`locationDetails.${index}.liveEvents.socialMediaLinks.facebook`}
                                  placeholder="https://facebook.com/su_perfil"
                                  className="mt-2 block w-full rounded-md border-gray-300 py-3 px-4 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleFieldChange(setFieldValue, `locationDetails.${index}.liveEvents.socialMediaLinks.facebook`, e.target.value)}
                                />
                              </div>
                              ...
                              <div>
                                ...
                                <Field
                                  type="text"
                                  name={`locationDetails.${index}.liveEvents.socialMediaLinks.twitter`}
                                  placeholder="https://twitter.com/su_perfil"
                                  className="mt-2 block w-full rounded-md border-gray-300 py-3 px-4 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleFieldChange(setFieldValue, `locationDetails.${index}.liveEvents.socialMediaLinks.twitter`, e.target.value)}
                                />
                              </div>
                              ...
                              <div>
                                ...
                                <Field
                                  type="text"
                                  name={`locationDetails.${index}.liveEvents.socialMediaLinks.tiktok`}
                                  placeholder="https://tiktok.com/@su_perfil"
                                  className="mt-2 block w-full rounded-md border-gray-300 py-3 px-4 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleFieldChange(setFieldValue, `locationDetails.${index}.liveEvents.socialMediaLinks.tiktok`, e.target.value)}
                                />
                              </div>
                              ...
                              <div>
                                ...
                                <Field
                                  type="text"
                                  name={`locationDetails.${index}.liveEvents.socialMediaLinks.other`}
                                  placeholder="URL de otra red social"
                                  className="mt-2 block w-full rounded-md border-gray-300 py-3 px-4 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleFieldChange(setFieldValue, `locationDetails.${index}.liveEvents.socialMediaLinks.other`, e.target.value)}
                                />
                              </div>
                            </div>
                          )}
